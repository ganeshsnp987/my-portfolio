...
I'm Ganesh Sanap, a seasoned DevOps Engineer skilled in Jenkins, GitLab CI/CD, and GitHub Actions. With expertise in Git, Ansible, Puppet, and Chef, I seamlessly provision infrastructure. I thrive in Docker and Kubernetes containerization, wielding Terraform and AWS CloudFormation for Infrastructure as Code. Monitoring with Prometheus and Grafana, alongside cloud mastery in AWS, Azure, and GCP, ensures top-notch performance. Committed to continuous improvement, I enhance software delivery processes and foster innovation within any DevOps team.
                            </p>
